  ...
  return (
    <div>
      ...
      <div className="search-bar">
        <input
          type="text" placeholder="Search by name, HSN, barcode, description..."
      ...
      <div className="card">
        <div className="table-container">
          <table>
            <thead>
              <tr>
                <th>Name</th><th>HSN</th><th>Sell Price</th><th>Cost</th>
                <th>Qty</th><th>Barcode</th><th>Category</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={8} style={{textAlign:'center',padding:30,color:'#999'}}>No products found</td></tr>
              ) : products.map(p => (
                <tr key={p.id}>
                  <td>
                    <div style={{display:'flex',alignItems:'center',gap:8}}>
                      {p.image ? <img src={p.image} alt="" style={{width:32,height:32,borderRadius:4,objectFit:'cover'}} /> : <span style={{fontSize:18}}>📦</span>}
                      <div>
                  ...
                  <td style={{fontSize:12}}>{p.category_name || '-'}{p.subcategory_name ? `/${p.subcategory_name}` : ''}</td>
                  <td>
          ...
          <div className="modal" style={{maxWidth:800}}>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input value={form.serial_number} onChange={e => setForm({...form, serial_number: e.target.value})} placeholder="Auto if empty" />
              </div>
              <div className="form-group">
                <label>Barcode</label>
                <input value={form.barcode} onChange={e => setForm({...form, barcode: e.target.value})} placeholder="Auto if empty" />
              </div>
            </div>
